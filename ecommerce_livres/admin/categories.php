                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= html_entity_decode(ucfirst($category['nom'])) ?></td>
                            <td><?= substr(html_entity_decode(ucfirst($category['description'])), 0, 40) . "...." ?></td>
                            <td><?php ?><a href="categories.php?categories_php&action=delete&id_categorie=<?=$category['id_categorie']?>">
                            <i class="bi bi-trash3-fill text-danger"></i>
                            </a></td>

                            <td><?php ?><a href="categories.php?categories_php&action=update&id_categorie=<?=$category['id_categorie']?>">

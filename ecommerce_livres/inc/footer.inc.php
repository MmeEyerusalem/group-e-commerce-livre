        ...
        <section class="final d-flex">
            <div class="marque col-6">
                <div class="retrait col-12 d-flex p-4">
                    <a class="sm col-12 col-md-4 logo-retrait" href="<?= RACINE_SITE ?>index.php">
                        <img src="<?=RACINE_SITE?>assets/img/logo-transparent-png.png" alt="Logo" height="150">
                    </a>
...
<script src="<?=RACINE_SITE?>ecommerce_livres/assets/js/script.js"></script>
</body>
